...
function EditDoctor() {
    ...
    const hospital=user.doctors.filter(
        (d)=>{
            return d._id==id
        }
    )
    const [name,setName]=useState(hospital[0].name)
    const [email,setEmail]=useState(hospital[0].email)
    const [phone,setPhone]=useState(hospital[0].phone)
    const [specialisation,setSpecialisation]=useState(hospital[0].specialisation)
    const [pay,setPay]=useState(hospital[0].pay)
      ...
      <ToastContainer />
        <div className="row my-3 d-flex align-items-center">
            ...
            <div className="col-md-6 pt-3">
             <div>
             <div className='heading-1 text-center'>EDIT DOCTOR</div>
                <div className="card shadow p-1">
                    <div className="card-body">
                        ...
                        <button className='btn btn-login my-3' onClick={handleSubmit}>Edit</button>
                    </div>
                </div>
             </div>  
            </div>
